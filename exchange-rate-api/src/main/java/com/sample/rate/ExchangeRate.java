package com.sample.rate;

import com.sample.rate.exception.ProviderNotFoundException;
...
public class ExchangeRate {
    private static final String DEFAULT_PROVIDER = "com.sample.rate.spi.DefaultFinanceExchangeRateProvider";
